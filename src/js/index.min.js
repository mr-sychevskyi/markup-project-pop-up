...
var modal=document.querySelector(".modal");var modalOverlay=document.querySelector(".modal-overlay");var modalHeader=document.querySelector(".modal-header");var modalContent=document.querySelector(".modal-content");var modalControls=document.querySelector(".modal-controls");var buttonsModal=document.querySelectorAll(".modal .btn");var buttonOpen=document.querySelector(".btn-modal-open");var buttonUninstall=document.querySelector(".btn-uninstall");var snackbar=document.querySelector(".snackbar");var showSnackbar=function showSnackbar(){setTimeout(function(){return snackbar.classList.add('show');},300);setTimeout(function(){return snackbar.classList.remove('show');},3000);};var toggleModal=function toggleModal(e){var currTarget=e.currentTarget;modal.classList.toggle("closed");modalOverlay.classList.toggle("closed");setTimeout(function(){return modalHeader.classList.add('slideUp');},300);setTimeout(function(){return modalContent.classList.add('slideUp');},600);setTimeout(function(){return modalControls.classList.add('slideUp');},900);if(currTarget===buttonUninstall){showSnackbar();}};var windowOnClick=function windowOnClick(e){var currTarget=e.target;if(currTarget===modalOverlay){toggleModal(e);}};window.addEventListener("click",windowOnClick);buttonOpen.addEventListener('click',toggleModal);[].concat(_toConsumableArray(buttonsModal)).forEach(function(item){return item.addEventListener('click',toggleModal);});